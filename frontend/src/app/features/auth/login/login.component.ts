...
@Component({
  ...
  template: `
    <div class="cyber-card">
      ...
      <div *ngIf="sessionExpired" class="warn-box">⚠ Session expired. Please log in again.</div>
  ...
  styles: [`
    ...
    .warn-box  { background:rgba(255,152,0,0.1); border:1px solid #ff9800; color:#ff9800; padding:12px; margin-bottom:20px; font-family:var(--font-family-mono); font-size:0.85rem; border-radius:4px; }
  `]
})
